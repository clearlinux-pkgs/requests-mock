...
%prep
%setup -q -n requests-mock-1.8.0
cd %{_builddir}/requests-mock-1.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588628700
...
cp %{_builddir}/requests-mock-1.8.0/LICENSE %{buildroot}/usr/share/package-licenses/requests-mock/a018430a439541feea5dbfb78eecb64b4140172e
